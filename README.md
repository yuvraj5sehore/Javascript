...
Q/How Code is Executed (The Compilation Phase) ?
      ...
      on the fly so it executes at lightning speed.ss
...
Q.what is event delegation?
      ...
      Ans.Event bubbling is a default mechanism in JavaScript where an event triggered on a nested child element propagates
            ...
            like a click occurs, it does not just stay on the targeted element. Instead, the browser runs the event 
            handlers in this specific order:
